...
export default function Home() {
  ...
  const privacyPolicyLink = "/privacy-policy.html"; // Create this HTML file in public folder

  // Direct link to Privacy Policy as PDF (optional)
  const privacyPolicyPDF = "/privacy-policy.pdf"; // If you have PDF version

  // Or link to an external privacy policy generator site (for quick setup)
  const privacyPolicyExternal = "https://app.privacypolicies.com/wizard/privacy-policy";
          ...
          <div className="footer-bottom">
            ...
            <div className="mt-6">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-cyan-400 hover:text-cyan-300 flex items-center gap-1 justify-center"
              >
